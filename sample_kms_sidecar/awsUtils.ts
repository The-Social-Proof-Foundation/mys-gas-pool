...
import { Secp256k1PublicKey } from "@mysten/mys.js/keypairs/secp256k1";
import { fromB64, toB64 } from "@mysten/mys.js/utils";
...
import {
    ...
    messageWithIntent,
    IntentScope,
} from "@mysten/mys.js/cryptography";

import { TransactionBlock } from "@mysten/mys.js/transactions";
import { getFullnodeUrl, MysClient } from "@mysten/mys.js/client";
...
export async function getPublicKey(keyId: string) {
    ...
    try {
        ...
        if (
            ...
            const mys_public_key = rawPublicKey
...
async function getSerializedSignature(
    ...
    const publicKeyToUse =
        mys_pubkey instanceof Secp256k1PublicKey ? mys_pubkey : undefined;
